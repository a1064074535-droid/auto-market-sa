...
// ===== BRAND COLORS ===== const BRAND_COLORS = {   toyota:     { primary: '#EB0A1E', secondary: '#000000', light: '#fff0f0', text: '#EB0A1E' },   lexus:      { primary: '#1A1A1A', secondary: '#C8A951', light: '#f5f0e8', text: '#C8A951' },   honda:      { primary: '#E40521', secondary: '#1A1A1A', light: '#fff0f0', text: '#E40521' },   nissan:     { primary: '#C3002F', secondary: '#1A1A1A', light: '#fff0f0', text: '#C3002F' },   infiniti:   { primary: '#B8860B', secondary: '#1A1A1A', light: '#fdf5e6', text: '#B8860B' },   bmw:        { primary: '#0066B2', secondary: '#1A1A1A', light: '#e8f4ff', text: '#0066B2' },   mercedes:   { primary: '#888B8D', secondary: '#1A1A1A', light: '#f0f0f0', text: '#555555' },   audi:       { primary: '#BB0A30', secondary: '#1A1A1A', light: '#fff0f0', text: '#BB0A30' },   volkswagen: { primary: '#001E50', secondary: '#00B0F0', light: '#e8f4ff', text: '#001E50' },   ford:       { primary: '#003499', secondary: '#1A1A1A', light: '#e8eeff', text: '#003499' },   chevrolet:  { primary: '#D4A017', secondary: '#1A1A1A', light: '#fdf5e0', text: '#B8860B' },   hyundai:    { primary: '#002C5F', secondary: '#00AAD2', light: '#e6f6ff', text: '#002C5F' },   kia:        { primary: '#BB162B', secondary: '#1A1A1A', light: '#fff0f2', text: '#BB162B' },   gmc:        { primary: '#CC0033', secondary: '#1A1A1A', light: '#fff0f2', text: '#CC0033' },   jeep:       { primary: '#1A5276', secondary: '#1A1A1A', light: '#e8f4ff', text: '#1A5276' },   dodge:      { primary: '#D01010', secondary: '#1A1A1A', light: '#fff0f0', text: '#D01010' },   ram:        { primary: '#1B1B1B', secondary: '#C41230', light: '#fff0f2', text: '#C41230' },   cadillac:   { primary: '#9B1B30', secondary: '#BFA45A', light: '#fdf5e0', text: '#9B1B30' },   land_rover: { primary: '#005A2B', secondary: '#C8A951', light: '#e8f5ee', text: '#005A2B' },   landrover:  { primary: '#005A2B', secondary: '#C8A951', light: '#e8f5ee', text: '#005A2B' },   jaguar:     { primary: '#1A1A1A', secondary: '#C8A951', light: '#f5f0e8', text: '#C8A951' },   porsche:    { primary: '#900021', secondary: '#C8A951', light: '#fdf5e0', text: '#900021' },   ferrari:    { primary: '#DC0000', secondary: '#FFCC00', light: '#fff5e6', text: '#DC0000' },   lamborghini:{ primary: '#1A1A1A', secondary: '#D4AF37', light: '#fdf5e0', text: '#D4AF37' },   maserati:   { primary: '#1A1A1A', secondary: '#003087', light: '#e8eeff', text: '#003087' },   bentley:    { primary: '#1A1A1A', secondary: '#3C8727', light: '#eef5ec', text: '#3C8727' },   rolls_royce:{ primary: '#2C2C2C', secondary: '#8B7536', light: '#f5f0e8', text: '#8B7536' },   volvo:      { primary: '#003057', secondary: '#FFCD00', light: '#e8f4ff', text: '#003057' },   peugeot:    { primary: '#1B2A78', secondary: '#C9A84C', light: '#e8eeff', text: '#1B2A78' },   renault:    { primary: '#EFDF00', secondary: '#1A1A1A', light: '#fffce0', text: '#B8A000' },   citroen:    { primary: '#CF0A0A', secondary: '#1A1A1A', light: '#fff0f0', text: '#CF0A0A' },   fiat:       { primary: '#DA291C', secondary: '#1A1A1A', light: '#fff0f0', text: '#DA291C' },   alfa_romeo: { primary: '#9B1B30', secondary: '#003082', light: '#e8eeff', text: '#9B1B30' },   subaru:     { primary: '#005BAA', secondary: '#1A1A1A', light: '#e8f4ff', text: '#005BAA' },   mitsubishi: { primary: '#D01010', secondary: '#1A1A1A', light: '#fff0f0', text: '#D01010' },   mazda:      { primary: '#910A2B', secondary: '#1A1A1A', light: '#fff0f0', text: '#910A2B' },   suzuki:     { primary: '#1A3A5C', secondary: '#E11B22', light: '#e8f4ff', text: '#1A3A5C' },   isuzu:      { primary: '#CF0A2C', secondary: '#1A1A1A', light: '#fff0f0', text: '#CF0A2C' },   lincoln:    { primary: '#1A1A1A', secondary: '#C8A951', light: '#f5f0e8', text: '#C8A951' },   acura:      { primary: '#CC0000', secondary: '#1A1A1A', light: '#fff0f0', text: '#CC0000' },   genesis:    { primary: '#1A1A1A', secondary: '#8B6914', light: '#f5f0e8', text: '#8B6914' },   chery:      { primary: '#003087', secondary: '#E00B0B', light: '#e8eeff', text: '#003087' },   geely:      { primary: '#003087', secondary: '#00AEEF', light: '#e8f4ff', text: '#003087' },   haval:      { primary: '#CC0000', secondary: '#1A1A1A', light: '#fff0f0', text: '#CC0000' },   mg:         { primary: '#A50034', secondary: '#1A1A1A', light: '#fff0f2', text: '#A50034' },   byd:        { primary: '#1B4F8A', secondary: '#00A651', light: '#e8f4ff', text: '#1B4F8A' },   tesla:      { primary: '#CC0000', secondary: '#1A1A1A', light: '#fff0f0', text: '#CC0000' },   rivian:     { primary: '#00A862', secondary: '#1A1A1A', light: '#e8f5ee', text: '#00A862' },   lucid:      { primary: '#E5A323', secondary: '#1A1A1A', light: '#fdf5e0', text: '#B8820A' },   default:    { primary: '#D4A017', secondary: '#1A1A1A', light: '#fdf5e0', text: '#B8860B' } };  function getBrandColor(brandEn) {   if (!brandEn) return BRAND_COLORS.default;   const key = brandEn.toLowerCase().replace(/[\s\-]+/g, '_').replace(/[^a-z_]/g, '');   return BRAND_COLORS[key] || BRAND_COLORS.default; }  function applyBrandTheme(brandEn) {   const colors = getBrandColor(brandEn);   const root = document.documentElement;   root.style.setProperty('--brand-primary', colors.primary);   root.style.setProperty('--brand-secondary', colors.secondary);   root.style.setProperty('--brand-light', colors.light);   root.style.setProperty('--brand-text', colors.text);   root.setAttribute('data-brand', brandEn ? brandEn.toLowerCase() : 'default'); }  // ===== HELPERS =====
function formatPrice(p) { return p  + ' ريال سعودي'; }
    ...
    return `
      <article class="car-card" role="listitem" tabindex="0"
        ...
        <div class="car-card-body">
          ...
          <div class="car-card-price" dir="ltr"><span>ر.س</span>${price }</div>
